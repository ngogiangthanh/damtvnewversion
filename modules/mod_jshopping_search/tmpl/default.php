...
<input type = "text" class = "inputbox" style = "width: 220px" name = "search" id = "jshop_search" value = "<?php print $search?>" placeholder="Nhập tên sản phẩm muốn tìm"/>
<input class = "btn btn-primary" type = "submit" value = "<?php print _JSHOP_GO?>" />
<?php if ($adv_search) {?>
