...
<table class = "jshop list_category">
    <?php foreach($this->categories as $k=>$category){?>
        ...
        <td class="jshop_categ" width="<?php print (100/$this->count_category_to_row)?>%" style="vertical-align: bottom !important">
          <table class = "category">
            ...
            <td class="image" align="center">
                ...
                <br/><a class = "product_link" href = "<?php print $category->category_link?>"><?php print $category->name?></a>
            </td>
            </tr>
           </table>
        </td>    
