...
<?php if ($this->allow_review){?>
    ...
    <?php if ($this->allow_review > 0){?>
        ...
        <br/>
        <i class="review"><?php print _JSHOP_ADD_REVIEW_PRODUCT?></i><br/><br/>
        ...
        <table id="jshop_review_write" >
            <tr>
                ...
                <td>
                    <input type="text" name="user_name" id="review_user_name" class="inputbox" value="<?php print $this->user->username?>" placeholder="Nhập tên của bạn"/>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input type="text" name="user_email" id="review_user_email" class="inputbox" value="<?php print $this->user->email?>"  placeholder="Nhập email của bạn"/>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <textarea name="review" id="review_review" rows="4" cols="40" class="jshop inputbox" style="width:320px;"  placeholder="Nội dung bình luận"></textarea>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <br/>
                    <input type="submit" class="btn btn-primary" value="<?php print _JSHOP_REVIEW_SUBMIT?>" />
                </td>
            </tr>
        </table>
        </form>
