...
class BaoKimPayment 
{
	...
	// Mã merchante site 
	private $merchant_id = '11233';	// Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site

	// Mật khẩu bảo mật
	private $secure_pass = '162628705cd91ee5'; // Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site
