...
class JSFactory{
    ...
    static $config;
        if (!is_object($config)){
			...
			$config->copyrightText = '<span id="mxcpr" style="display:none"><a target="_blank" href="http://www.webdesigner-profi.de/">Copyright MAXXmarketing Webdesigner GmbH</a></span>';
