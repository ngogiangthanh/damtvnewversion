...
<body id="jsn-master" class="<?php echo $this->bodyClass ?>">
	...
	?>
		...
		?>
			...
			<?php
				foreach ($this->promoColumns AS $id => $class) {
					...
					if ($id == 'promo') {
			?>
                    <div id="jsn-pos-promo" class="<?php echo $class['span']; ?> <?php echo $class['order']; ?> <?php echo $class['offset']; ?>"><div id="jsn-pos-promo_inner">
			...
			?>
                    <div id="jsn-pos-promo-left" class="<?php echo $class['span']; ?> <?php echo $class['order']; ?> <?php echo $class['offset']; ?>"><div id="jsn-pos-promo-left_inner">
			...
			?>
                    <div id="jsn-pos-promo-right" class="<?php echo $class['span']; ?> <?php echo $class['order']; ?> <?php echo $class['offset']; ?>"><div id="jsn-pos-promo-right_inner">
			...
			?>
				<div id="jsn-pos-content-top" class="jsn-modulescontainer jsn-horizontallayout jsn-modulescontainer<?php echo $jsnutils->countModules('content-top'); ?>"><div id="jsn-pos-content-top_inner" class="row-fluid">
		...
		?>
			<div id="jsn-content" class="<?php echo (($this->hasLeft)?'jsn-hasleft ':'') ?><?php echo (($this->hasRight)?'jsn-hasright ':'') ?><?php echo (($this->hasInnerLeft)?'jsn-hasinnerleft ':'') ?><?php echo (($this->hasInnerRight)?'jsn-hasinnerright ':'') ?> row-fluid">
		<?php
			foreach ($this->mainColumns AS $id => $class) {
				if ($id == 'content') {
		?>
				<div id="jsn-maincontent" class="<?php echo $class['span']; ?> <?php echo $class['order']; ?> <?php echo $class['offset']; ?>"><div id="jsn-pos-maincontent">
		<?php
	...
	<div id="jsn-brand">
		<a href="http://www.joomlashine.com/joomla-templates.html" title="Joomla templates by Joomlashine" target="_blank"><strong>Free joomla templates</strong></a> by Joomlashine
	</div>
