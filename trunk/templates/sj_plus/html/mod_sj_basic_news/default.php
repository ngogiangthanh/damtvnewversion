	...
	<div class="bsn-wrap">
	 ...
	 ?>
	  <div class="item post<?php if($params->get('showline')){ echo ' showlinebottom'.$iditem; } ?>">
		        	...
		        	<div class="bsn-image">
                            ...
                            <div class="image-overlay">
								<div class="hover-links clearfix">
									<a href="<?php echo $items->image;?>" title="" data-rel="prettyPhoto" class="hover-zoom"><i class="icon-external-link"></i></a>
									<a href="<?php echo $items->link;?>" class="hover-link"><i class="icon-plus"></i></a>
								</div>
							</div>
		        ...
		        <?php } ?>
			        <h2>
			        	<i class="icon-add"></i><a title="<?php echo $items->title?>" target="<?php echo $options->item_link_target; ?>" href="<?php echo $items->link?>"><?php echo YTools::truncate($items->title,$options->item_title_max_characs);?></a>
			        </h2>
