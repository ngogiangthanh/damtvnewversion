...
<div class="control-group">
	...
	<div class="controls">
		<select id="<?php echo "{$this->id}_type"; ?>" name="<?php echo $this->name ?>[type]" autocomplete="off">
			...
			<option value="<?php echo $type; ?>"<?php echo $this->value['type'] == $type ? ' selected' : ''; ?><?php echo ($data['pro'] AND ! $this->edition->isPro()) ? ' class="jsn-pro-edition-only"' : ''; ?>>
...
<?php foreach ($this->options AS $type => $data) : ?>
	<?php if ( ! $data['pro'] OR $this->edition->isPro()) : ?>
	...
	<div class="control-group">
		...
		<div class="controls">
			<div<?php echo empty($data['suffix']) ? '' : ' class="input-append"'; ?>>
				...
				<input class="input-mini <?php echo $data['class']; ?>" id="<?php echo "{$this->id}_type_{$type}_value"; ?>" name="<?php echo $this->name ?>[<?php echo $type; ?>]" type="number" value="<?php echo (int) @$this->value[$type]; ?>" />
