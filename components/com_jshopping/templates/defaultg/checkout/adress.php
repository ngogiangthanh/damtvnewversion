...
<form action = "<?php print $this->action ?>" method = "post" name = "loginForm" onsubmit = "return validateCheckoutAdressForm('<?php print $this->live_path ?>', this.name)" >
    ...
    <?php print _JSHOP_DELIVERY_ADRESS ?>
        <label for = "delivery_adress_1"><input type = "radio" name = "delivery_adress" id = "delivery_adress_1" value = "0" <?php if (!$this->delivery_adress) {?> checked = "checked" <?php } ?> onclick = "jQuery('#div_delivery').hide()" />&nbsp;<?php print _JSHOP_NO ?></label>
    <label for = "delivery_adress_2"><input type = "radio" name = "delivery_adress" id = "delivery_adress_2" value = "1" <?php if ($this->delivery_adress) {?> checked = "checked" <?php } ?> onclick = "jQuery('#div_delivery').show()" />&nbsp;<?php print _JSHOP_YES ?></label>
    </div>
    <?php }?>
    ...
    <div style="padding-top:10px;">
        ...
        <div class="requiredtext">Lưu ý: <i><b>* <?php print _JSHOP_REQUIRED?></b></i></div>
        <?php echo $this->_tmpl_address_html_9?>
        <input type = "submit" name = "next" value = "<?php print _JSHOP_NEXT ?>" class = "btn btn-primary" />&nbsp;
        <input type = "reset" name = "reset" value = "Làm lại" class = "btn btn-special" />
    </div>
</form>
</div>
