...
<div class="previewfinish_block_cart">
...
<textarea class = "inputbox" id = "order_add_info" name = "order_add_info" placeholder="Ghi gì đó cho chúng tôi"></textarea>

<?php if ($this->config->display_agb && false){?>
<div class="row_agb">            
...
<?php }?>
<table class="jshop" align="center">
 <tr>
   <td style="text-align:center;padding-top:3px;">
       <input class="btn btn-primary" type="submit" name="finish_registration" value="<?php print _JSHOP_ORDER_FINISH?>" <?php if ($this->config->display_agb){?>onclick="return checkAGB()"<?php }?> />
   </td>
 </tr>
</table>
