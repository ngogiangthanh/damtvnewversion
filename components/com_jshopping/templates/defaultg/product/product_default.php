...
<input type="button" class="btn btn-special" value="<?php print _JSHOP_BACK;?>" onclick="<?php print $this->product->button_back_js_click;?>" />
</div>
<?php }?>
<br/>
<div class="jshop_prod_description" style="border: 1px solid #aaa;padding: 10px">
