...
<table class="jshop cart">
  <tr style="height: 30px;">
    <th width="20%" style="background: #a8d7f0!important;color:#000;vertical-align: middle;text-align: center">
      <?php print _JSHOP_IMAGE?>
    </th>
    <th  style="background: #a8d7f0!important;color:#000;vertical-align: middle;text-align: center">
      <?php print _JSHOP_ITEM?>
    </th>    
    <th width="15%" style="background: #a8d7f0!important;color:#000;vertical-align: middle;text-align: center">
    ...
    <th width="10%" style="background: #a8d7f0!important;color:#000;vertical-align: middle;text-align: center">
  ...
  <tr class="jshop_prod_cart <?php if ($i%2==0) print "even"; else print "odd"?>">
    <td class="jshop_img_description_center" style="text-align: center;vertical-align: middle">
    ...
    <td class="product_name" style="text-align: center;vertical-align: middle">
