...
<div class="jshop">
    ...
    <div class = "jshop_register" style="padding-top:0px;">
      <table>
        ...
        <tr>
          ...
          <td>
              <input type = "text" name = "f_name" id = "f_name" value = "" class = "inputbox" placeholder="Nhập họ và tên"/>
          </td>
        </tr>
        <?php } ?>
        ...
        <tr>
          ...
          <td>
            <input type = "text" name = "email" id = "email" value = "" class = "inputbox"  placeholder="Nhập email của bạn"/>
          </td>
        </tr>
        <?php } ?>
        ...
        <tr>
          ...
          <td>            
            <?php echo JHTML::_('calendar', '', 'birthday', 'birthday', $this->config->field_birthday_format, array('class'=>'inputbox', 'size'=>'25', 'maxlength'=>'19','placeholder'=>'dd.mm.yyyy'));?>
          </td>
        </tr>
        <?php } ?>
      </table>
    ...
    <div class = "jshop_register">
      <table>
        ...
        <tr>
          ...
          <td>
            <input type = "text" name = "street" id = "street" value = "" class = "inputbox"  placeholder="Nhập địa chỉ của bạn" />
          </td>
        </tr>
        <?php } ?>
        ...
        <tr>
          ...
          <td>
            <input type = "text" name = "city" id = "city" value = "" class = "inputbox"  placeholder="Nhập tên tỉnh - thành phố"/>
          </td>
        </tr>
        <?php } ?>
    ...
    <div class = "jshop_register">
      <table>
        ...
        <tr>
          ...
          <td>
            <input type = "text" name = "mobil_phone" id = "mobil_phone" value = "" class = "inputbox"  placeholder="Nhập số điện thoại của bạn"/>
          </td>
        </tr>
        <?php } ?>
    ...
    <div class = "jshop_register">
      <table>
        ...
        <tr>
          ...
          <td>
            <input type = "text" name = "u_name" id = "u_name" value = "" class = "inputbox"  placeholder="Nhập mói tài khoản"/>
          </td>
        </tr>
        <?php } ?>
        ...
        <tr>
          ...
          <td>
            <input type = "password" name = "password" id = "password" value = "" class = "inputbox"  placeholder="Mật khẩu"/>
          </td>
        </tr>
        <?php } ?>
        ...
        <tr>
          ...
          <td>
            <input type = "password" name = "password_2" id = "password_2" value = "" class = "inputbox"  placeholder="Xác nhận lại mật khẩu"/>
          </td>
        </tr>
        <?php } ?>
    ...
    <div class="requiredtext">Lưu ý: <b><i>* <?php print _JSHOP_REQUIRED?></i></b></div>
    <?php echo $this->_tmpl_register_html_6?>
    <?php echo JHtml::_('form.token');?>
    <input type = "submit" value = "<?php print _JSHOP_SEND_REGISTRATION ?>" class = "btn btn-primary" />&nbsp;
    <input type = "reset" value = "Làm lại" class = "btn btn-special" />
    </form>
</div>