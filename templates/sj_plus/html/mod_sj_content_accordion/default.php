		...
		<div class="acd-items">
			...
			<div class="acd-item">
				<div class="acd-header">
					<i class="icon-add"></i><?php echo SjContentAccordionHelper::truncate($item->title, $params->get('item_title_max_characters',25)); ?>
				</div>
						...
						<div class="acd-image cf">
							...
							<div class="image-overlay">
								<div class="hover-links clearfix">
									<?php //var_dump($item->image_fulltext);die(); ?>
									<a class="hover-zoom" data-rel="prettyPhoto" title="" href="<?php echo $img['src']; ?>"><i class="icon-external-link"></i></a>
